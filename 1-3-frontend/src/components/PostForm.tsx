            ...
            <Card>
                <CardBody className="space-y-4">
                        ...
                        <div className="bg-default-100 p-2 rounded-lg mb-2 flex gap-2 flex-wrap items-center">
                            <Dropdown>
                                ...
                                >
                                    ...
                                    <DropdownItem
                                        key="3"
                                        className={editor?.isActive("heading", {level: 3}) ? "bg-default-200" : ""}
                                    >
                                        Heading 3
                                    </DropdownItem>
                                </DropdownMenu>
                        ...
                        <Select label="Add Tags" selectedKeys={selectedTags.map((tag) => tag.id)}>
                            <SelectSection>
                                {suggestedTags.map((tag) => (
                                    <SelectItem key={tag.id} value={tag.id} onClick={() => handleTagAdd(tag)}>
                                        {tag.name}
                                    </SelectItem>
                                ))}
                            </SelectSection>
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        <Button color="danger" variant="flat" onClick={onCancel} disabled={isSubmitting}>
                            Cancel
                        </Button>
