...
const CategoriesPage: React.FC<CategoriesPageProps> = ({isAuthenticated}) => {
    //You declare generic types explicitly when the initial value alone doesn’t
    // give TypeScript enough information about the type you intend.
    // [] is ambiguous (could be any[]), so you write useState<Category[]>([])
    // null needs type hint like string | null or Category | null
    //     TypeScript infers type automatically from the initial value:
...
// This is the proper way to use isLoading in a NextUI Button component. When isSubmitting is true, the button will:

// Show a loading spinner

// Be disabled (to prevent multiple clicks)

// Maintain its width to prevent layout shift

// The button text ("Update" or "Add") will be replaced with the spinner while loading
